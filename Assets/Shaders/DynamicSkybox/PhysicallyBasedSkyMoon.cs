...
/// </summary>
public enum PhysicallyBasedSkyMoonModel
{
...
public sealed class PhysicallyBasedSkyModelParameter : VolumeParameter<PhysicallyBasedSkyMoonModel>
{
    /// <summary>
    /// constructor.
    /// </summary>
    ...
    public PhysicallyBasedSkyModelParameter(PhysicallyBasedSkyMoonModel value, bool overrideState = false)
...
/// </summary>
[VolumeComponentMenu("Sky/Physically Based Sky Moon")]
[SkyUniqueID((int)5)]
...
public partial class PhysicallyBasedSkyMoon : SkySettings
{
    ...
    public PhysicallyBasedSkyModelParameter type = new PhysicallyBasedSkyModelParameter(PhysicallyBasedSkyMoonModel.EarthAdvanced);
    ...
    /// <summary> Ground color texture. Does not affect the precomputation. </summary>
    [Tooltip("Specifies a Texture that represents the planet's specular surface. Does not affect the precomputation.")]
    public CubemapParameter groundSpecTexture = new CubemapParameter(null);
    ...
    /// <summary> Ground color texture. Does not affect the precomputation. </summary>
    [Tooltip("Specifies a Texture that represents the planet's specular surface. Does not affect the precomputation.")]
    public CubemapParameter cloudTexture = new CubemapParameter(null);
    ...
    {
        if (type.value != PhysicallyBasedSkyMoonModel.Custom)
        {
    ...
    internal float GetMaximumAltitude()
    {
        ...
        float aerosolMaxAltitude = (type.value == PhysicallyBasedSkyMoonModel.EarthSimple) ? k_DefaultAerosolMaximumAltitude : aerosolMaximumAltitude.value;
    ...
    {
        if (sphericalMode.value && (type.value != PhysicallyBasedSkyMoonModel.EarthSimple))
        {
    ...
    {
        if (type.value == PhysicallyBasedSkyMoonModel.EarthSimple)
        {
    ...
    PhysicallyBasedSkyMoon()
    {
        displayName = "Physically Based Sky Moon";
    }
    ...
    public override Type GetSkyRendererType() { return typeof(PhysicallyBasedSkyMoonRenderer); }
}
