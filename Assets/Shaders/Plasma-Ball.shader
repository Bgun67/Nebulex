...
Shader "Particles/Plasma-Ball" {
Properties {
    _TintColor ("Tint Color", Color) = (0.5,0.5,0.5,0.5)
    _MainTex ("Particle Texture", 2D) = "white" {}
    _InvFade ("Soft Particles Factor", Range(0.01,3.0)) = 1.0
    _Center("Center", Vector) = (0.0,0.0,0.0)
    _Radius("Radius", Range(0,100.0)) = 1.0
    _Factor("Factor", Range(-100.0,100.0)) = 1.0
}
    ...
    SubShader {
        Pass {
            ...
            v2f vert (appdata_t v)
            {
                ...
                o.vertex = UnityObjectToClipPos(_Center + normalize( v.vertex - _Center) * (distance( v.vertex, _Center) - _Radius));
